            ...
            <tbody className="divide-y divide-[#E8E2D9]/40">
              {sortedHoldings.length > 0 ? sortedHoldings.map(h => (
                <tr key={h.id} className="hover:bg-[#F1EFE9]/30 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="font-mono text-sm text-[#2D2926] font-bold">{formatCurrency(h.value, settings.baseCurrency)}</div>
                    <div className="text-[10px] text-[#6B645E] font-mono font-medium mt-0.5">{t.unitPriceLabel} {formatCurrency(h.currentPrice, settings.baseCurrency)}</div>
                  </td>
                  <td className="px-6 py-4 text-right">
                ...
                {isOpen && (
                  <div className="px-4 pb-4 space-y-3">
                    <div className="grid grid-cols-2 gap-3 bg-[#F1EFE9] border border-[#E8E2D9] rounded-xl p-3">
                      ...
                      <div>
                        <div className="text-[9px] font-bold uppercase tracking-wider text-[#9E958C]">{t.unitPriceLabel}</div>
                        <div className="text-xs font-mono font-bold text-[#2D2926] mt-0.5">{formatCurrency(h.currentPrice, settings.baseCurrency)}</div>
                      </div>
                      <div>
